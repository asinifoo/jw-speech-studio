              ...
              <div style={{
                ...
                {categories.map(c => (
                  <button key={c} onClick={() => { setCategory(c); setSelOutline(''); setSelSpeaker(null); setExpanded(false); setEditing(false); setSearchQ(''); }} style={{
                    flex: 1, padding: '6px 4px 4px', borderRadius: 8, fontSize: '0.786rem', fontWeight: category === c ? 700 : 500,
                    border: 'none',
                    ...
                    <span style={{
                      fontSize: '0.571rem', fontWeight: 600, color: category === c ? '#D85A30' : 'var(--c-dim)',
