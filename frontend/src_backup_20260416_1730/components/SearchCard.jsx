          ...
          {!editing && !dbEditing && (
            <>
              <button onClick={startEdit} style={{
                ...
                background: 'var(--bg-card)', color: 'var(--c-faint)', fontSize: rem(9), cursor: 'pointer', minWidth: 32, textAlign: 'center',
              }}>수정</button>
              <button onClick={startDbEdit} style={{
                padding: '2px 6px', borderRadius: 4, border: '1px solid var(--tint-red-bd)',
                background: 'var(--bg-card)', color: '#c44', fontSize: rem(9), cursor: 'pointer', minWidth: 32, textAlign: 'center',
              }}>DB</button>
            </>
          )}
        </div>
